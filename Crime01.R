...
#read files
Crime2010<-read.csv("Crimes2010.csv",header=TRUE,stringsAsFactors=FALSE)
Crime2011<-read.csv("Crimes2011.csv",header=TRUE,stringsAsFactors=FALSE)
Crime2012<-read.csv("Crimes2012.csv",header=TRUE,stringsAsFactors=FALSE)
Crime2013<-read.csv("Crimes2013.csv",header=TRUE,stringsAsFactors=FALSE)
Crime2014<-read.csv("Crimes2014.csv",header=TRUE,stringsAsFactors=FALSE)
str(Crime2010)
str(Crime2011)
str(Crime2012)
str(Crime2013)
